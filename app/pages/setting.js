    ...
    return (
        <Layout>
            ...
            <div class="mx-auto container max-w-2xl md:w-3/4 shadow-md">
                <div class="bg-blueEce p-4 border-t-2 border-darkblue rounded-t">
                        ...
                        <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
                            <div>
                                ...
                                <div class="w-full inline-flex border">
                                    ...
                                    <input type="text" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" placeholder="myUsername" disabled/>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="md:w-2/3 mx-auto max-w-sm space-y-5">
                            <div>
                                ...
                                <div class="w-full inline-flex border">
                                    ...
                                    <input type="text" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" placeholder="Firstname" disabled/>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="w-full inline-flex border">
                                    ...
                                    <input type="text" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" placeholder="Lastname" disabled/>
                                </div>
                            </div>
                            <div>
                                ...
                                <div class="w-full inline-flex border">
                                    ...
                                    <input type="text" class="w-11/12 focus:outline-none focus:text-gray-600 p-2" placeholder="06XXXXXXXX" disabled/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:inline-flex w-full space-y-4 md:space-y-0 p-8 text-gray-500 items-center">
                        ...
                        <div class="md:w-5/12 w-full md:pl-9 max-w-sm mx-auto space-y-5 md:inline-flex pl-2">
                            <div class="w-full inline-flex border-b">
                                ...
                                <input type="password" class="w-11/12 focus:outline-none focus:text-gray-600 p-2 ml-4" placeholder="Mypassword" disabled/>
                            </div>
                        </div>
                    </div>
                    <hr />
