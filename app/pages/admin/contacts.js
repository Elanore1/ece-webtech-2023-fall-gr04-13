...
export default function Contacts() {
  ...
  return (
    <Layout
      ...
      >
      <h1 className='mt-4 wt-title text-darkblue text-center'>
            ...
            <div>
              <div id="alert-2" className="flex items-center p-4 mb-4 text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                ...
                <div className="ms-3 text-sm font-medium">
                  Viewing messages is not authorized, please <a href={`/login`} className="font-semibold underline hover:no-underline">login</a> to access them.
                </div>
              </div>
