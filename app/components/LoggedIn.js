        ...
        {isSmallScreen ? (
            <Disclosure as="div" className="-mx-3">
                ...
                <>
                    ...
                    <ul className="py-2 text-sm" aria-labelledby="avatarButton">
                        <li>
                            <a href="#" className="flex block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-white hover:bg-darkblue">
                                Setting
            ...
            <Popover.Button className=" lg:px-8 flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900">
                ...
                <div class="indicator ml-4">
                    <Link href ='#'><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="white"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z" /></svg> </Link>
                </div> 
                <Transition as={Fragment} enter="transition ease-out duration-200" enterFrom="opacity-0 translate-y-1" enterTo="opacity-100 translate-y-0" leave="transition ease-in duration-150" leaveFrom="opacity-100 translate-y-0" leaveTo="opacity-0 translate-y-1">
                    <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-50 overflow-hidden rounded-3xl bg-whiteSpecial shadow w-44 ring-1 ring-gray-900/5">
                        ...
                        <div class="py-1">
                            <button onClick={onClickLogout} class="flex w-44 block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 ">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor"aria-hidden="true" class="h-6 w-6">
